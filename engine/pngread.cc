/*
	...
	Sample file taken from http://macdevcenter.com/pub/a/mac/2005/10/14/texture-maps.html?page=1
	Uses libpng to load a png picture.

	Credits to original author.

	Bugs fixed by Jens Henrik Hertz (s052797)
	Copyright 2010
